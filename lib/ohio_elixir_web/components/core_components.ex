defmodule OhioElixirWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OhioElixirWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OhioElixirWeb.Gettext, "errors", msg, opts)
    end
  end

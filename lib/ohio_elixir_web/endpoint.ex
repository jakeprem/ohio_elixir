defmodule OhioElixirWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :ohio_elixir
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :ohio_elixir
  end

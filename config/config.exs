...
config :ohio_elixir, OhioElixirWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: OhioElixirWeb.ErrorHTML, json: OhioElixirWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: OhioElixir.PubSub,
  live_view: [signing_salt: "beOWfGnP"]
...
config :ohio_elixir, OhioElixir.Mailer, adapter: Swoosh.Adapters.Local
